...
public class Builder {
	...
	private static final int SLIDE_THUMBNAIL_WIDTH = 80;

	private static final int SLIDE_THUMBNAIL_HEIGHT = 80;
	...
	protected static JPanel buildSlideSwitcher() {
		 ...
		 * 
		 * JButton makeCopy = new JButton("Make Copy"); JButton repeat = new
		 * JButton("Repeat x times"); JButton repeatUntil = new
		 * JButton("Repeat Until..."); modal.add(makeCopy); modal.add(repeat);
		...
		// I chose not to use a JButton b/c I cant seem to control the LAF on a
		// per-component basis
